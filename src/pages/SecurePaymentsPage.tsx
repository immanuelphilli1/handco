...
import { SecurePaymentsPageContent } from '../components/SecurePaymentsPageContent'
...
type SecurePaymentsPageProps = {
  authUser: AuthUser | null
  onSignedIn: (email: string) => void
  onSignOut: () => void
}

export function SecurePaymentsPage({ authUser, onSignedIn, onSignOut }: SecurePaymentsPageProps) {
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full min-w-0 max-w-360 overflow-x-clip bg-bg-primary">
        <SecurePaymentsPageContent onGoHome={handleGoHome} />
        <Footer />
      </div>
      <BackToTopButton />
    </>
