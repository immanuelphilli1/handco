...
import { IntellectualPropertyPageContent } from '../components/IntellectualPropertyPageContent'
...
type IntellectualPropertyPageProps = {
  ...
  return (
    <>
      ...
      <div className="mx-auto w-full min-w-0 max-w-360 overflow-x-clip bg-bg-primary">
        <IntellectualPropertyPageContent onGoHome={handleGoHome} />
        <Footer />
      </div>
      <BackToTopButton />
    </>
